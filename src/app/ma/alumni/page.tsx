...
export default function AlumniMAPage() {
  ...
  // useEffect untuk mengambil data alumni dari Supabase
  useEffect(() => {
        ...
        <div className="container mx-auto p-4 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2">
              Jejak para lulusan Madrasah Aliyah.
            </p>
          </div>
                  ...
                  <div key={year} className="mb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {groupedAlumni[parseInt(year)].map((member) => (
                        <div
                          key={member.id}
                          className="bg-white p-4 rounded-lg shadow-md flex items-center space-x-4 transform hover:bg-blue-50 transition-colors"
                        >
