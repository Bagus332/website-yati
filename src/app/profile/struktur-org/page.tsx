    ...
    <>
      ...
      <main className="container mx-auto py-8 px-4">
        ...
        <p className="mb-6">
          ...
          kelancaran operasional dan pembinaan santri secara optimal. Berikut
          adalah susunan organisasi di Ponpes Yati:
        </p>
        ...
        <p>
          ...
          memastikan seluruh program dan kegiatan di pesantren berjalan dengan
