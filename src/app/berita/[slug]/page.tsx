...
export default async function ArticlePage({
  ...
  const articleUrl = `https://your-domain.com/berita/${params.slug}`;
  ...
  return (
    <>
      ...
      <main className="bg-gradient-to-b from-blue-50 to-white font-sans py-12 px-4">
        {/* Kontainer Grid untuk tata letak 2 kolom */}
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
          {/* Kolom Utama untuk Konten Artikel (berada di tengah, ambil 2 kolom) */}
          <div className="lg:col-span-2">
            <article className="bg-white/80 backdrop-blur-lg p-6 sm:p-8 lg:p-12 rounded-2xl shadow-2xl border border-gray-100">
              {/* Back to News link */}
              <div className="mb-6">
                <a
                  href="/berita"
              ...
              {article.image_url && (
                <div className="mb-8 rounded-2xl overflow-hidden shadow-xl max-w-1x1 mx-auto">
                  <Image
          ...
          {/* Kolom Sidebar untuk Berita Terkini (berada di kanan) */}
