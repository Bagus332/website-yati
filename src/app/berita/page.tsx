...
export default function BeritaPage() {
  ...
  const fetchArticles = async (page: number) => {
    ...
    if (data) {
      setArticles(prevArticles => page === 0 ? data : [...prevArticles, ...data]);
        ...
        <motion.div
          ...
          >
            ...
            <p className="text-gray-600 mt-6 text-lg max-w-2xl mx-auto">
              Ikuti perkembangan dan kegiatan terbaru dari Pondok Pesantren YATI Kamang Mudik.
            </p>
        </motion.div>
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <div className="flex-grow">
                        <h2 className="text-xl font-bold text-gray-800 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors">{article.title}</h2>
